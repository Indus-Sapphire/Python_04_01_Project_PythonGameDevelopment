...
* **Persistent Statistics:** The game features a master scoreboard that saves locally to a JSON file. It tracks lifetime sessions played, win/loss ratios, average completion times, and country-specific accuracy.
